...
urlpatterns = [
    ...
    path('manifestacao-e-abundancia/', ManifestingSeminar.as_view(),
         name='manifesting'),
    path('voce-e-seu-parceiro/', SignificantOtherSeminar.as_view(),
    ...
    path('doencas-e-desordens/', DiseaseSeminar.as_view(),
         name='disease-and-disorder'),
    path('crianca-arco-iris/', RainbowChildrenSeminar.as_view(),
