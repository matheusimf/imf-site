# Generated by Django 2.2 on 2019-08-07 06:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instructor', models.ManyToManyField(blank=True, to='seminars.Instructor')),
                ('location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='seminars.SeminarLocation')),
                ('seminar_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='seminars.SeminarType')),
            ],
        ),
        migrations.AddField(
